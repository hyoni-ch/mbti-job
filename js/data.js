// data.js
// 앞에 4개의 질문을 통해 mbti를 결론내고, 나머지 질문은 가짜 질문
...
export const questions = [
  {
    ...
    choices: [
      {
        text: "파티 스텝은 못하지...<br>(그래도 파티는 재밌겠다..)",
        value: "i",
      },
  ...
  },
  {
    ...
    choices: [
      { text: "짐도 다 챙겼고 준비는 완벽해!<br>일찍 자야지~", value: "s" },
      {
        text: "다 챙겼겠지?<br>여분 옷을 좀 더 챙길까..(뒤적뒤적)",
        value: "n",
      },
    ],
  },
  {
    ...
    choices: [
      ...
      { text: "아 이직하나?<br>퇴사하고 뭐 하냐고 물어봐야지.", value: "t" },
    ],
  },
  {
    number: "04",
